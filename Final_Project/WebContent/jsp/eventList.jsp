				...
				<div class="col-8">
					...
					<nav>
						<ul class="pagination justify-content-center">
							<li
								class="page-item <c:if test="${ start == 1 }">disabled</c:if>"><a
								class="page-link" href="eventList.do?page=1"> <span
									aria-hidden="true">&laquo;</span>
							</a></li>
							<li
								class="page-item <c:if test="${ start == 1 }">disabled</c:if>"><a
								class="page-link" href="eventList.do?page=${ start - 1 }">이전</a></li>
								...
								<c:choose>
									...
									<c:otherwise>
										<li class="page-item"><a class="page-link"
											href="eventList.do?page=${ i }">${ i }</a></li>
									</c:otherwise>
								</c:choose>
							</c:forEach>
							<li
								class="page-item <c:if test="${ last <= end }">disabled</c:if>"><a
								class="page-link" href="eventList.do?page=${ end + 1 }">다음</a></li>
							<li
								class="page-item <c:if test="${ last <= end }">disabled</c:if>"><a
								class="page-link" href="eventList.do?page=${ last }"
