							...
							<tr>
								...
								<td class="text-right">
									<button class="btn btn-sm btn-secondary"
										onclick="location.href='noticeList.do'">더보기</button>
								</td>
							</tr>
							<tr height=10>
							</tr>
								...
								<td colspan=3>
									<ul class="list-group">
										<c:forEach items="${notice}" var="n">
											<li class="list-group-item">[공지] ${n.notice_title}</li>
										</c:forEach>
					...
					<div class="data2">
						<table style="width: 700px;">
							<tr>
								...
								<td class="text-right">
									<button class="btn btn-sm btn-secondary"
										onclick="location.href='faq.do'">더보기</button>
								</td>
							</tr>
							<tr height=10></tr>
							<tr>
								<td colspan=3>
									<ul class="list-group">
										<c:forEach items="${faq}" var="f">
											<li class="list-group-item">${f.faq_title}</li>
										</c:forEach>
